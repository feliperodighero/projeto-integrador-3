...
function validadelaboratoryrua() {
    ...
    var validadelaboratoryruaError = document.getElementById("ValidadeLaboratoryRuaError");
...
function ValidadeLaboratoryCPF() {
    ...
    var validadelaboratorycpf = document.getElementById("ValidadeLaboratoryCPFError");
...
function ValidadeLaboratoryCEP() {
    ...
    var regex = /^\d{5}-\d{3}$/;
    var validadelaboratorycepError = document.getElementById("ValidadeLaboratoryCEPError");
...
function ValidadeLaboratoryTelefonerror() {
    ...
    var laboratorynumberphoneError = document.getElementById("ValidadeLaboratoryTelefoneError");
...
function validateLaboratoryNumber() {
    var laboratoryNumber = document.getElementById("LaboratoryNumberAddress").value;
    var regex = /^[a-zA-Z0-9]+$/; // Regex para letras e números
    var validadelaboratorynumeroError = document.getElementById("ValidadeLaboratoryNumeroError");
